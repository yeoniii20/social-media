...
export const FRIENDS_SUGGESTION = [
  {
    id: 1,
    name: '이창호',
    mutual: '함께 아는 친구 10명',
...
export const FRIENDS_LIST = [
  { id: 1, name: '이진주', profileImg: friend4, status: 'online' as Status },
  { id: 2, name: '구승택', profileImg: friend5, status: 'away' as Status },
  { id: 3, name: '김소연', profileImg: friend6, status: 'offline' as Status },
  { id: 4, name: '박현수', profileImg: friend7, status: 'offline' as Status },
  { id: 5, name: '권현서', profileImg: friend8, status: 'offline' as Status },
  { id: 6, name: '김지현', profileImg: friend9, status: 'offline' as Status },
  { id: 7, name: '김산하', profileImg: friend10, status: 'offline' as Status },
  { id: 8, name: '최유림', profileImg: friend11, status: 'online' as Status },
  { id: 9, name: '송새미', profileImg: friend12, status: 'away' as Status },
  { id: 10, name: '김세연', profileImg: friend13, status: 'offline' as Status },
  { id: 11, name: '유지수', profileImg: friend14, status: 'offline' as Status },
  { id: 12, name: '강건하', profileImg: friend15, status: 'offline' as Status },
  { id: 13, name: '최진혁', profileImg: friend16, status: 'online' as Status },
  { id: 14, name: '박도현', profileImg: friend17, status: 'online' as Status },
  { id: 15, name: '김예나', profileImg: friend18, status: 'offline' as Status },
  { id: 16, name: '이영은', profileImg: friend19, status: 'offline' as Status },
  { id: 17, name: '김세진', profileImg: friend21, status: 'offline' as Status },
  { id: 18, name: '추영우', profileImg: friend22, status: 'offline' as Status },
  { id: 19, name: '김바로', profileImg: friend23, status: 'offline' as Status },
  { id: 20, name: '최진석', profileImg: friend24, status: 'away' as Status },
  { id: 21, name: '이준영', profileImg: friend25, status: 'offline' as Status },
];
